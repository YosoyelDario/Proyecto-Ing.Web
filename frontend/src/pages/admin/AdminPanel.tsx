...
function TarjetaAcceso({
  icono, titulo, descripcion, onClick, color = '#3aada0',
}: {
  icono: string
  titulo: string
  descripcion: string
  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 0 24 24" fill="none" stroke="#c8d3dc" strokeWidth={2}
    ...
    <IonPage>
      <IonContent fullscreen className="bg-[#f4faf9]">
        ...
        <div className="min-h-screen flex flex-col font-['DM_Sans',sans-serif]">
          ...
          {/* ── Header ─────────────────────────────────────────────────── */}
          <div className="bg-[#3aada0] px-6 pt-14 pb-8 flex flex-col gap-1">
            <div className="flex items-center justify-between mb-2">
              <BotonVolver to="/" label="Inicio" className="!text-white/80 hover:!text-white" />
              <span className="text-[12px] text-white/60 font-mono">Panel Admin</span>
            </div>
